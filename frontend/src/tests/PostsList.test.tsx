...
describe('Success State - Header', () => {
  ...
  it('should render page description', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/Discover and read the latest posts/i)).toBeInTheDocument();
    });
  });
});
...
describe('Success State - Posts Grid', () => {
  ...
  it('should not display image section when imageUrl is null', async () => {
    ...
    expect(document.querySelector('.post-card-image')).not.toBeInTheDocument();
  });
  ...
  it('should display avatar placeholder when no avatar', async () => {
    ...
    await waitFor(() => {
      const placeholder = document.querySelector('.post-card-avatar-placeholder');
...
describe('Empty State', () => {
  it('should display empty message when no posts exist', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByRole('heading', { level: 2, name: /No Posts Found/i })).toBeInTheDocument();
    });
  });
  ...
  it('should display descriptive empty message', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/There are no posts to display yet/i)).toBeInTheDocument();
    });
  });
...
describe('Pagination', () => {
  ...
  it('should enable "Next" button on pages before last', async () => {
    const mockResponse = {
      ...
      metadata: { totalItems: 30, currentPage: 1, pageSize: 10, totalPages: 3 }
    };
  ...
  it('should handle content with nested HTML elements', async () => {
    const mockResponse = {
      items: [{
        id: 1,
        title: 'Post',
        content: '<div><p>Text with <span><em>nested</em></span> elements</p></div>',
        imageUrl: null,
        isPublished: true,
        created_at: '2025-01-15T15:30:00Z',
        updatedAt: '2025-01-15T15:30:00Z',
...
describe('Accessibility', () => {
  ...
  it('should use h2 for post titles', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByRole('heading', { level: 2, name: 'Test Post' })).toBeInTheDocument();
    });
  });
});
...
describe('Responsive Behavior', () => {
  ...
  it('should render properly with many posts', async () => {
    ...
    const mockResponse = {
      items: mockPosts,
      metadata: { totalItems: 10, currentPage: 1, pageSize: 10, totalPages: 1 }
    };
